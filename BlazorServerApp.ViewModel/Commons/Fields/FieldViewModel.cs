...
public partial class FieldViewModel<T> : ObservableObject, IFieldViewModel
{
    ...
    public T? Value
    {
        ...
        set
        {
            ...
            // On autorise la modification, via le code , m�me si ReadOnly = true, pour permettre les modifications par le code (ex: calcul� dans le VM), mais pas par l'utilisateur via l'UI.
            //if (ReadOnly) return;
